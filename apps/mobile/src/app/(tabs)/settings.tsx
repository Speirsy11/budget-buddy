  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: colors.bg }}>
      ...
      >
        ...
        {/* Profile Section */}
        <View
          style={[styles.section, { backgroundColor: colors.surface.sage }]}
        >
        ...
        <View style={[styles.section, { backgroundColor: colors.surface.sky }]}>
          ...
          <View
            style={[styles.divider, { backgroundColor: "rgba(0,0,0,0.07)" }]}
          />
          <View style={styles.settingRow}>
            <View style={styles.settingInfo}>
        ...
        {/* Data Section */}
        <View
          style={[styles.section, { backgroundColor: colors.surface.linen }]}
        >
        ...
        >
          ...
          <View style={styles.aboutRow}>
            ...
            <Text style={[styles.aboutValue, { color: colors.ink }]}>
              1.0.0
            </Text>
          </View>
          <View
